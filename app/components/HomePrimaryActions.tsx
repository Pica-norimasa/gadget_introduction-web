...
export function HomePrimaryActions() {
  return (
    <div className="mt-4 grid grid-cols-3 gap-2" aria-label="最初にできること">
      <a
        href="#feed"
        onClick={(event) => {
        ...
        className="flex min-h-14 flex-col items-center justify-center gap-1.5 rounded-xl border border-[var(--line)] bg-[var(--bg-raised)] px-2 py-2 text-center text-[var(--ink)] transition-colors hover:border-[var(--accent)] sm:min-h-16 sm:flex-row sm:justify-start sm:gap-3 sm:px-4 sm:py-3 sm:text-left"
      >

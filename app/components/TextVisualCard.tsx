export function TextVisualCard({
  ...
  return (
    ...
    >
      ...
      />
      <div className="relative flex h-full w-full flex-col justify-between rounded-lg border border-white/30 bg-white/18 p-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.35)] backdrop-blur-[1px]">
        ...
        <div>
          {title && (
            <p
              className={`mb-2 font-[family-name:var(--font-display)] font-bold leading-tight ${
                isLarge ? "line-clamp-2 text-[18px]" : "line-clamp-2 text-[15px]"
              }`}
          ...
          <p
            className={`font-[family-name:var(--font-display)] font-bold leading-snug ${
              isLarge ? "line-clamp-4 text-[16px]" : "line-clamp-4 text-[13.5px]"
            }`}

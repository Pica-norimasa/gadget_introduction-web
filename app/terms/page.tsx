...
const SECTIONS = [
  ...
  },
  {
    title: "2. アカウントについて",
    body: [
      "本サービスは現在、ブラウザに保存される軽量なセッション情報によって投稿者を識別する仕組みを採用しています。メールアドレスやパスワードによる正式なアカウント登録機能はまだ提供していません。",
      "そのため、Cookieの削除や別のブラウザ・端末からのアクセスにより、これまでの投稿・フォロー等の情報を引き継げなくなる場合があります。あらかじめご了承ください。",
    ],
  },
  {
    title: "3. 禁止事項",
